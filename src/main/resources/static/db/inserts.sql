INSERT INTO `articles` VALUES
  (1, 'Hello, One!', 'Далеко-далеко за словесными горами в стране гласных и согласных живут рыбные тексты.',
   ...
   'Simon Pirko', 'Tech', '2017-05-29');
INSERT INTO `articles` VALUES
  (2, 'Hello, Two!', 'Хорошо бы еще немного поспать и забыть всю эту чепуху.',
   ...
   'Denis Dmitruk', 'Automobile', '2017-05-28');
INSERT INTO `articles` VALUES
  (3, 'Hello, Three!',
